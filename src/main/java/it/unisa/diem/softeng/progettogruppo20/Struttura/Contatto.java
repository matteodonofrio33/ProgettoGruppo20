 ...
 * 
 * per l'implementazione dell'ordinamento è stato utilizzato un compareTo(..) implementando l'interfaccia Comparable
 * 
 * @author Luigi Cocco
...
public class Contatto implements Comparable{
     ...
     * Se devono essere modificate l'emailVecchia oppure il telefonoVecchio allora viene invocato modificaDato(..)
     * 
     * @pre '   nomeNuovo!=null || cognomeNuovo!=null || emailNuova!=null || telefonoNuovo!=null   '
     * @post il contatto è stato modificato
     * @invariant i dati del contatto ai quali sono associati (parametroNuovo == null) non devono essere modificati 
     * 
     ...
     * @param[in] telefonoVecchio è il numero di telefono che si vuole sovrascrivere
     * @param[in] telefonoNuovo è il numero di telefono che sovrascrive telefonoVecchio
     * @see modificaDato()
     * @return se la modifica è avvenuta con successo ritorna true, altrimenti false
     */
